...
public class ModelAndView {
	...
	public void addAllAttributes(Collection<?> attributeValues){
		this.getModelMap().addAllAttributes(attributeValues);
	}

	public void addAllAttributes(Map<String, Object> attributes){
		this.getModelMap().addAllAttributes(attributes);
	}

	public void mergeAttributes(Map<String, Object> attributes){
		this.getModelMap().mergeAttributes(attributes);
	}

	public boolean containsAttribute(String attributeName){
		return this.getModelMap().containsAttribute(attributeName);
	}
